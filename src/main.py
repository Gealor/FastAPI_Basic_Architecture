...
# все функции middleware принимают request, т.е. исходящий запрос от пользователя и call_next - функция, которая принимает request
# и возвращает результат, полученный в результате соответствующей операции с путями.
